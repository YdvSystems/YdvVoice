...
- **Commit `[conv-18]` `96c8118` LOCAL** (8 retouches `plan/00` + 12 `plan/02`, re-solo de cohérence OK, gitleaks OK). **`technique/` INTACT** (notes d'écart sur Go). **Push en clôture** : `[conv-15]`/`[conv-16]` sur `origin/main` ; **`[conv-17]` · `[audit-fable]` `2dcabc0` · `[conv-18]` `96c8118` restent à pousser**.
