...
`docs/PATTERN-v3.0-CLAUDE-CODE-STANDARD.md` *(privé — local, hors dépôt)* → `CLAUDE.md` (racine) → `docs/journal/JOURNAL-ARBITRAGES.md` (jusqu'à **A32** + les 3 principes transversaux + la section **« Passe de réalité »**) → `docs/IMPLEMENTATION.md` → `docs/VISION.md`. Puis ce RELAY.
