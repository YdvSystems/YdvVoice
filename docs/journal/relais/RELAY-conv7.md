...
- **#4 Dépendance Anthropic = VIGILANCE N°1** : hedge = multi-provider (A38) + sobriété + roue de secours — **réduit, n'élimine pas**. Quota Yohann **~85 % hebdo (x5)** par son dev pro → résolution via **x20**.
