...
**Notes d'écart à porter aux sources (sur Go, groupées avec les portages accumulés convs 16→21)** : `technique/03` §4.6 (la ligne tablée au tableau qui-reçoit-quoi source — FC-1). *(Les autres corrections vivent au niveau plan/checklist — aucune ne touche une source.)*
