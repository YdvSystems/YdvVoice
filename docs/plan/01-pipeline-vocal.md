...
>
> **Statut** : rédigé + **solo de fidélité renforcé (conv 14)** avant le croisé — couture injectable `evt.speaker`, alternatives de prises rétablies, invariants `01` §5 ancrés. **Audit croisé 2 agents à venir** (proposé d'office). **Valeurs chiffrées différées** à la calibration Phase 3 (rubrique 6) — la couche audio en concentre les plus lourdes (les **deux 🔴** du projet vivent ici).
>
